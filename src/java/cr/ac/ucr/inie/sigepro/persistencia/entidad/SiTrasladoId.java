...
/**
 * SiTrasladoId generated by hbm2java
 */
@Embeddable
public class SiTrasladoId  implements java.io.Serializable {
    ...
    public SiTrasladoId(int numero, int anno) {
       this.numero = numero;
       this.anno = anno;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SiTrasladoId) ) return false;
		 SiTrasladoId castOther = ( SiTrasladoId ) other; 
