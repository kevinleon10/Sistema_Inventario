...
/**
 * SiPrestamoId generated by hbm2java
 */
@Embeddable
public class SiPrestamoId  implements java.io.Serializable {
    ...
    public SiPrestamoId(int numero, int anno) {
       this.numero = numero;
       this.anno = anno;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SiPrestamoId) ) return false;
		 SiPrestamoId castOther = ( SiPrestamoId ) other; 
